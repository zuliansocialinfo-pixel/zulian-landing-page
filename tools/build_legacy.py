...
import html
import json
from certificate_gallery import patch_generated_certificate_page
...
# The canonical route is generated by build.py using the same site shell. Replace
# only its main content with the evidence-backed gallery after all legacy targets
# have been validated, so the old /formazione URL still redirects correctly.
patch_generated_certificate_page(ROOT)

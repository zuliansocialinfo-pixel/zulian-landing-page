...
- Name: tier2/application-load.spec.ts >> Application Load (Preloader) - Tier 2 >> T1.2.7: Verify the preloader logo container becomes visible and satisfies size requirements (>= 100px)
- Location: e2e-tests/tier2/application-load.spec.ts:79:3
...
Locator: locator('.preloader-logo-container')
Expected: visible
Timeout: 6000ms
...
Call log:
  ...
  - waiting for locator('.preloader-logo-container')

...
- Name: tier4/scenarios.spec.ts >> Real-World Application Scenarios - Tier 4 >> S5: User scrolls through page verifying all animations
- Location: e2e-tests/tier4/scenarios.spec.ts:104:3
...
Locator:  locator('section#preventivi div').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('section#preventivi div').first()
    14 × locator resolved to <div id="prezzi"></div>
...
- main:
  ...
  - text: +150 Clienti +2M Impression / mese +45 Progetti completati 98% Soddisfazione
